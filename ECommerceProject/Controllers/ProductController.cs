...
namespace ECommerceProject.Controllers
{
    public class ProductController : Controller
    {
        ...
        public IActionResult Index(decimal? lowamount, decimal? largeamount)
        {
            ...
            {
                data = _context.Products.Include(p => p.ProductTypes).OrderByDescending(_ => _.ProductTypes.ProductType).ToList();
            }
        ...
        public async Task<IActionResult> Edit(int? id, Products products, IFormFile image)
        {
            if (ModelState.IsValid)
            {
                ...
                var exP = _context.Products.Where(_ => _.Id == id).FirstOrDefault();
                exP.Image = products.Image;
                exP.Name = products.Name;
                exP.ProductColor = products.ProductColor;
                exP.ProductTypes = products.ProductTypes;
                _context.Products.Update(exP);
                await _context.SaveChangesAsync();
                return RedirectToAction(nameof(Index));
            }
